...
const WrapUpChart: React.FC<Props> = ({ data }) => {
  ...
  const leftMargin = isMobile ? 120 : 240;
  const labelWidth = isMobile ? 110 : 230;
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <YAxis 
            ...
            width={labelWidth}
            fontWeight="700"
            tickFormatter={(val) => isMobile && val.length > 20 ? val.substring(0, 17) + '...' : val}
          />
          <Tooltip 
          ...
          />
          <Bar dataKey="count" radius={[0, 4, 4, 0]} barSize={isMobile ? 18 : 24}>
